...
def fetch_dracaugames_product(
    ...
    # Vérifie que le produit est bien Pokémon

    if not is_pokemon_product(
        name,
        page_text
    ):
        return None

    # Recherche les mentions du 30e anniversaire
...
def fetch_dracaugames():
    ...
    # On récupère tous les liens produits
